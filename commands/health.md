...
- Available tools: `echo`, `get_ticker`, `get_ohlcv`, `get_order_book`, `get_trades`, `resolve_symbol`, `compute_vwap`, `identify_support_resistance`, `volatility_regime`, `analyze_snapshot`
